      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 relative z-10 lg:max-w-xl xl:max-w-2xl w-full">
        ...
        <div className="w-full max-w-md flex flex-col gap-6">
          ...
          <div className="space-y-1 text-left">
            <h1 className="text-2xl font-bold tracking-tight font-outfit text-white">Welcome back</h1>
            <p className="text-xs text-slate-400">Sign in to your console to manage causal pipelines.</p>
          </div>
