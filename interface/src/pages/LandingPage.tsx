...
targeting_policy = assign_quadrants(cate_scores)`
  ...
  return (
    <div className="relative min-h-screen bg-[#050608] text-[#e2e8f0] overflow-x-hidden font-sans">
      {/* MongoDB style forest-green glow meshes */}
      <div className="absolute top-[-10%] left-[-20%] w-[60%] h-[60%] rounded-full bg-radial-gradient from-emerald-950/15 via-emerald-900/5 to-transparent blur-[140px] pointer-events-none" />
      <div className="absolute top-[35%] right-[-10%] w-[50%] h-[50%] rounded-full bg-radial-gradient from-indigo-950/20 via-slate-900/5 to-transparent blur-[140px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-radial-gradient from-emerald-950/10 via-slate-900/5 to-transparent blur-[140px] pointer-events-none" />
      ...
      <header className="sticky top-0 z-50 border-b border-slate-900/80 bg-[#050608]/75 backdrop-blur-md">
        <div className="max-w-[1300px] mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-lg bg-gradient-to-tr from-emerald-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-emerald-500/10">
              <Compass className="h-4.5 w-4.5 text-white" />
            </div>
            <span className="text-md font-bold tracking-tight font-outfit text-white bg-clip-text">
              IMC Causal Lab
            </span>
          </div>
          
          <nav className="hidden md:flex items-center gap-8 text-[13px] font-medium text-slate-400">
            <a href="#simulator" className="hover:text-white transition-colors">Interactive Tour</a>
            <a href="#sandbox" className="hover:text-white transition-colors">DAG Sandbox</a>
            <a href="#docs-preview" className="hover:text-white transition-colors">Core Concepts</a>
          ...
          <div className="flex items-center gap-3">
            <Button 
              variant="ghost" 
              className="text-slate-400 hover:text-white hover:bg-slate-900/50 text-[13px] font-medium px-4 h-9"
              onClick={handleExploreDemo}
            >
              Explore Demo
            </Button>
            <Button 
              className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white hover:brightness-110 active:scale-98 transition-all font-semibold text-[13px] px-5 h-9 rounded-md shadow-md shadow-emerald-500/15"
      ...
      <section className="relative z-10 max-w-[1300px] mx-auto px-6 pt-16 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.05] text-white font-outfit">
              Prove and optimize
              <span className="block mt-2 bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 via-teal-300 to-indigo-400">
                true marketing lift.
              </span>
            </h1>
            
            <p className="text-slate-400 text-base sm:text-lg max-w-[550px] leading-relaxed font-normal">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-3">
              <Button 
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-emerald-500 to-emerald-600 text-white hover:brightness-110 active:scale-98 font-bold px-8 h-12 shadow-lg shadow-emerald-500/25 flex items-center justify-center gap-2 group"
                onClick={handleLaunch}
              >
              ...
              <Button 
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-slate-800 bg-slate-900/20 hover:bg-slate-900/60 hover:border-slate-700 text-slate-300 hover:text-white h-12 px-6 flex items-center justify-center gap-2"
                onClick={handleExploreDemo}
              >
                <PlayCircle className="h-4.5 w-4.5 text-emerald-400" /> Explore Demo sandbox
              </Button>
            </div>

            {/* Micro Stats Bar */}
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-slate-900/80 max-w-[500px]">
              <div>
                <div className="text-2xl font-bold font-outfit text-white">4+</div>
                <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-0.5">Estimator Types</div>
              </div>
              <div>
                <div className="text-2xl font-bold font-outfit text-white">100%</div>
                <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-0.5">Session Isolation</div>
              </div>
              <div>
                <div className="text-2xl font-bold font-outfit text-white">Double ML</div>
          ...
          <div className="lg:col-span-6 flex justify-center">
            <div className="relative w-full max-w-[480px] aspect-video rounded-xl border border-slate-800 bg-gradient-to-b from-slate-950/80 to-slate-950/20 p-5 shadow-2xl overflow-hidden group">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-slate-400 font-medium">Estimated ATE (Sales Uplift)</span>
                  <span className="text-emerald-400 font-bold font-mono">+$4.82 / conversion</span>
                </div>
                <div className="w-full bg-slate-900 h-2.5 rounded-full overflow-hidden">
                  <div className="bg-gradient-to-r from-emerald-500 to-teal-400 h-full rounded-full w-[78%] animate-pulse" />
                </div>
                <div className="text-[11px] text-slate-500 leading-relaxed bg-[#06080d] p-3 border border-slate-900 rounded-lg font-mono">
                  <p className="text-slate-400 font-semibold mb-1">Causal Forest Summary</p>
                  <p>&gt; p-value: 0.002 (Highly Significant)</p>
                  <p>&gt; 95% Confidence Interval: [3.91, 5.73]</p>
                  <p>&gt; Target Persuadables ratio: 18.2%</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ────────────────────────────────────────────────────────────────────────
          ...
          ──────────────────────────────────────────────────────────────────────── */}
      <section id="simulator" className="border-t border-slate-900 bg-[#06080d]/60 py-24 relative">
        <div className="max-w-[1300px] mx-auto px-6">
          ...
          <div 
            ...
            className="relative w-full max-w-[850px] mx-auto border border-slate-800 bg-[#090b11] rounded-2xl shadow-2xl overflow-hidden"
          >
            {/* Header / Tabs */}
            <div className="flex items-center justify-between bg-[#06080c] border-b border-slate-900 px-6 py-3 select-none">
              <div className="flex items-center gap-1.5">
              ...
              <div className="flex items-center bg-[#0a0d16] border border-slate-900 rounded-lg p-0.5 text-xs font-medium">
                <button 
                  onClick={(e) => handleSimTabClick("graph", e)}
                  className={`px-3 py-1.5 rounded-md transition-all ${simTab === "graph" ? "bg-slate-800 text-white font-bold" : "text-slate-500 hover:text-slate-300"}`}
                >
                  1. Causal Graph
                </button>
                <button 
                  onClick={(e) => handleSimTabClick("compare", e)}
                  className={`px-3 py-1.5 rounded-md transition-all ${simTab === "compare" ? "bg-slate-800 text-white font-bold" : "text-slate-500 hover:text-slate-300"}`}
                >
                  2. Estimator Benchmarks
                </button>
                <button 
                  onClick={(e) => handleSimTabClick("allocate", e)}
                  className={`px-3 py-1.5 rounded-md transition-all ${simTab === "allocate" ? "bg-slate-800 text-white font-bold" : "text-slate-500 hover:text-slate-300"}`}
                >
                  3. Budget Optimizer
                </button>
              </div>
              ...
              <button 
                ...
                className="text-[10px] font-mono flex items-center gap-1.5 px-2 py-1 rounded bg-slate-900 hover:bg-slate-800 text-slate-400 border border-slate-800"
              >
                <RefreshCw className={`h-3 w-3 ${isAutoPlaying ? "animate-spin text-emerald-400" : ""}`} />
            ...
            <div className="p-6 sm:p-8 min-h-[380px] flex flex-col justify-between">
              ...
              {simTab === "graph" && (
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center flex-1">
                  {/* Visual Causal Graph */}
                  <div className="md:col-span-7 flex flex-col items-center justify-center p-4 border border-slate-900 bg-slate-950/40 rounded-xl min-h-[260px] relative">
                    <span className="absolute top-2 left-3 text-[9px] font-mono text-slate-600 uppercase tracking-wider">Causal Structure discovery (Causal Discovery)</span>
                    ...
                    <svg className="w-full h-[180px]" viewBox="0 0 350 180">
                      ...
                      {/* Nodes */}
                      <g>
                        <circle cx="60" cy="90" r="20" fill="#0f172a" stroke="#10b981" strokeWidth="2" />
                        <text x="60" y="93" textAnchor="middle" fill="#10b981" className="text-[8px] font-mono font-bold">SPEND</text>
                      </g>
                      <g>
                        <circle cx="200" cy="90" r="20" fill="#0f172a" stroke="#475569" strokeWidth="1.5" />
                        <text x="200" y="93" textAnchor="middle" fill="#94a3b8" className="text-[8px] font-mono">SEASON</text>
                      </g>
                      <g>
                        <circle cx="290" cy="90" r="20" fill="#0f172a" stroke="#6366f1" strokeWidth="2" />
                        <text x="290" y="93" textAnchor="middle" fill="#818cf8" className="text-[8px] font-mono font-bold">SALES</text>
                      </g>
                    </svg>
                    <div className="text-[10px] font-mono text-slate-500 border-t border-slate-900 pt-3 w-full text-center">
                      Identified adjustment set: <span className="text-emerald-400 font-bold">{"{Seasonality}"}</span>
                    </div>
                  </div>

                  {/* Terminal Log Console */}
                  <div className="md:col-span-5 bg-black/85 rounded-xl p-4 border border-slate-900 font-mono text-[10px] text-slate-400 leading-relaxed min-h-[260px] flex flex-col justify-between overflow-hidden">
              ...
              {simTab === "compare" && (
                <div className="space-y-6 flex-1 flex flex-col justify-center">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="bg-[#0b0e17] border border-slate-800 rounded-xl p-4 space-y-2 relative overflow-hidden">
                      ...
                      <div className="text-xl font-bold text-white font-mono">+$3.12 <span className="text-xs text-slate-500 font-normal">/ unit</span></div>
                      <div className="text-[10px] text-slate-400">Uplift Qini AUC: <span className="font-bold text-slate-300">0.68</span></div>
                    </div>
                    
                    <div className="bg-[#0c1219] border border-emerald-900/50 rounded-xl p-4 space-y-2 relative overflow-hidden shadow-lg shadow-emerald-500/[0.02]">
                      <div className="absolute top-0 left-0 w-full h-[3px] bg-emerald-500" />
                      <div className="flex items-center justify-between">
                        <span className="text-[10px] text-emerald-400 uppercase font-semibold">Causal Forest (RF)</span>
                        <span className="text-[8px] bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-1 rounded font-bold">BEST</span>
                      </div>
                      <div className="text-xl font-bold text-emerald-400 font-mono">+$4.82 <span className="text-xs text-slate-500 font-normal">/ unit</span></div>
                      <div className="text-[10px] text-slate-400">Uplift Qini AUC: <span className="font-bold text-emerald-400">0.82</span></div>
                    </div>
                    
                    <div className="bg-[#0b0e17] border border-slate-800 rounded-xl p-4 space-y-2 relative overflow-hidden">
                      <div className="absolute top-0 left-0 w-full h-[3px] bg-indigo-500" />
                      <div className="text-[10px] text-slate-500 uppercase font-semibold">DR-Learner (Double ML)</div>
                      <div className="text-xl font-bold text-white font-mono">+$4.75 <span className="text-xs text-slate-500 font-normal">/ unit</span></div>
                      <div className="text-[10px] text-slate-400">Uplift Qini AUC: <span className="font-bold text-slate-300">0.79</span></div>
                    </div>
                  </div>

                  {/* Benchmark charts mock representation */}
                  <div className="bg-slate-950/60 border border-slate-900 p-4 rounded-xl space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="space-y-1">
                        <div className="flex justify-between text-[10px] font-mono">
                          <span className="text-slate-400">Causal Forest (Maximized targeting efficiency)</span>
                          <span className="text-emerald-400 font-bold">82% Uplift Lift</span>
                        </div>
                        <div className="w-full bg-slate-900 h-2 rounded-full overflow-hidden">
                          <div className="bg-emerald-500 h-full rounded-full w-[82%] transition-all duration-1000" />
                        </div>
                      </div>
                      <div className="space-y-1">
                        <div className="flex justify-between text-[10px] font-mono">
                          <span className="text-slate-400">Double ML DR-Learner</span>
                          <span className="text-indigo-400 font-bold">79% Uplift Lift</span>
                        </div>
                        <div className="w-full bg-slate-900 h-2 rounded-full overflow-hidden">
                      ...
                      <div className="space-y-1">
                        <div className="flex justify-between text-[10px] font-mono">
                          <span className="text-slate-400">Correlation Baseline (Standard Multi-Attribution)</span>
                          <span className="text-slate-500 font-bold">48% Uplift Lift</span>
                        </div>
                        <div className="w-full bg-slate-900 h-2 rounded-full overflow-hidden">
                          <div className="bg-slate-700 h-full rounded-full w-[48%] transition-all duration-1000" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {simTab === "allocate" && (
                <div className="space-y-6 flex-1 flex flex-col justify-center">
                  <div className="bg-[#0b131a] border border-emerald-950 p-5 rounded-xl flex items-center justify-between gap-6">
                    <div className="space-y-1">
                      <div className="text-xs font-semibold text-emerald-400 flex items-center gap-1.5">
                        <TrendingUp className="h-4 w-4" /> Recommended Optimization Policy
                      </div>
                      <p className="text-xs text-slate-400 max-w-[450px] leading-relaxed">
                        Reallocate <span className="text-white font-bold font-mono">$15,000</span> from low-incrementality Search Ads to High-Uplift Display segments.
                      </p>
                    </div>
                    <div className="text-right shrink-0">
                      <div className="text-2xl font-extrabold text-emerald-400 font-mono font-outfit">+18.4%</div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="border border-slate-900 bg-slate-950/40 p-4 rounded-xl space-y-3">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between text-xs">
                          <span className="text-slate-400 font-mono">Search Campaigns</span>
                          <span className="text-white font-semibold">$18,000</span>
                        </div>
                        <div className="w-full bg-slate-900 h-1.5 rounded-full overflow-hidden">
                          <div className="bg-slate-600 h-full w-[72%]" />
                        </div>
                        
                        <div className="flex items-center justify-between text-xs">
                          <span className="text-slate-400 font-mono">Display Campaigns</span>
                    ...
                    <div className="border border-slate-900 bg-[#070b12]/50 p-4 rounded-xl space-y-3 shadow-lg shadow-emerald-500/[0.01]">
                      <span className="text-[10px] font-mono text-emerald-400/80 uppercase block">Optimized Allocation ($25k budget)</span>
                      <div className="space-y-2">
                        <div className="flex items-center justify-between text-xs">
                          <span className="text-slate-300 font-mono">Search Campaigns</span>
                          <span className="text-emerald-400 font-semibold">$3,000</span>
                        </div>
                        <div className="w-full bg-slate-900 h-1.5 rounded-full overflow-hidden">
                          <div className="bg-slate-700 h-full w-[12%]" />
                        </div>
                        
                        <div className="flex items-center justify-between text-xs">
                          <span className="text-slate-300 font-mono">Display Campaigns</span>
                          <span className="text-emerald-400 font-semibold font-mono">$22,000</span>
                        </div>
                        <div className="w-full bg-slate-900 h-1.5 rounded-full overflow-hidden">
              ...
              <div className="border-t border-slate-900/60 pt-4 flex items-center justify-between text-xs text-slate-500">
                ...
                <span className="font-mono text-[10px] text-slate-600">Click any tab button above to pause autoplay and interact manually.</span>
              </div>
            ...
            >
              <MousePointer className={`h-5 w-5 text-emerald-400 fill-emerald-400 shadow-md ${isCursorClicking ? "scale-75 text-emerald-300 fill-emerald-300" : ""}`} />
            </div>
      ...
      {/* ────────────────────────────────────────────────────────────────────────
          ...
          ──────────────────────────────────────────────────────────────────────── */}
      <section id="sandbox" className="py-24 border-t border-slate-900 relative">
        <div className="max-w-[1300px] mx-auto px-6">
          <div className="text-center max-w-[700px] mx-auto mb-14 space-y-4">
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white font-outfit">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 border border-slate-800 bg-[#07090e] rounded-2xl p-5 flex flex-col justify-between min-h-[420px]">
              
              {/* Presets header */}
              <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-900 pb-4 mb-4 select-none">
                <div className="flex items-center gap-2">
                  <Database className="h-4 w-4 text-emerald-400" />
                  <span className="text-xs font-semibold text-white font-mono">Graph Structure Canvas</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] text-slate-500 uppercase tracking-wider mr-1">Presets:</span>
                  <button 
                    onClick={() => applyPreset("standard")}
                    className="text-[10px] px-2.5 py-1 rounded border border-slate-800 bg-slate-900 text-slate-300 hover:text-white"
                  >
                    Fully Connected
                  </button>
                  <button 
              ...
              <div className="flex-1 flex items-center justify-center min-h-[250px] relative bg-slate-950/30 rounded-xl border border-slate-900/50 p-2">
                <span className="absolute top-2 right-3 text-[9px] font-mono text-slate-600 uppercase">Click edges to toggle paths</span>
                ...
                <svg className="w-full h-[240px] max-w-[480px]" viewBox="0 0 400 240">
                  <defs>
                    <marker id="arrow" viewBox="0 0 10 10" refX="17" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                      <path d="M 0 1.5 L 10 5 L 0 8.5 z" fill="#4f46e5" />
                    </marker>
                    <marker id="arrow-emerald" viewBox="0 0 10 10" refX="17" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                  ...
                  <g className="cursor-pointer" onClick={() => setPaths({ ...paths, X_to_T: !paths.X_to_T })}>
                    <path 
                      ...
                      fill="none" 
                      stroke={paths.X_to_T ? "#10b981" : "#1e293b"} 
                      strokeWidth={paths.X_to_T ? "2.5" : "1.5"}
                      strokeDasharray={paths.X_to_T ? "0" : "4,4"}
                      markerEnd={paths.X_to_T ? "url(#arrow-emerald)" : "url(#arrow-muted)"}
                      className="hover:stroke-emerald-400 transition-colors"
                    />
                    <rect x="135" y="65" width="22" height="14" rx="3" fill="#07090e" stroke={paths.X_to_T ? "#10b981" : "#1e293b"} strokeWidth="1" />
                    <text x="146" y="75" textAnchor="middle" fill={paths.X_to_T ? "#10b981" : "#475569"} className="text-[8px] font-mono font-bold select-none">{paths.X_to_T ? "ON" : "OFF"}</text>
                  </g>
                  ...
                  <g className="cursor-pointer" onClick={() => setPaths({ ...paths, X_to_Y: !paths.X_to_Y })}>
                    <path 
                      ...
                      fill="none" 
                      stroke={paths.X_to_Y ? "#10b981" : "#1e293b"} 
                      strokeWidth={paths.X_to_Y ? "2.5" : "1.5"}
                      strokeDasharray={paths.X_to_Y ? "0" : "4,4"}
                      markerEnd={paths.X_to_Y ? "url(#arrow-emerald)" : "url(#arrow-muted)"}
                      className="hover:stroke-emerald-400 transition-colors"
                    />
                    <rect x="240" y="65" width="22" height="14" rx="3" fill="#07090e" stroke={paths.X_to_Y ? "#10b981" : "#1e293b"} strokeWidth="1" />
                    <text x="251" y="75" textAnchor="middle" fill={paths.X_to_Y ? "#10b981" : "#475569"} className="text-[8px] font-mono font-bold select-none">{paths.X_to_Y ? "ON" : "OFF"}</text>
                  </g>
                  ...
                  <g className="cursor-pointer" onClick={() => setPaths({ ...paths, T_to_M: !paths.T_to_M })}>
                    <path 
                      ...
                      fill="none" 
                      stroke={paths.T_to_M ? "#4f46e5" : "#1e293b"} 
                    ...
                    />
                    <rect x="135" y="150" width="22" height="14" rx="3" fill="#07090e" stroke={paths.T_to_M ? "#4f46e5" : "#1e293b"} strokeWidth="1" />
                    <text x="146" y="160" textAnchor="middle" fill={paths.T_to_M ? "#818cf8" : "#475569"} className="text-[8px] font-mono font-bold select-none">{paths.T_to_M ? "ON" : "OFF"}</text>
                  </g>
                  ...
                  <g className="cursor-pointer" onClick={() => setPaths({ ...paths, M_to_Y: !paths.M_to_Y })}>
                    <path 
                      ...
                      fill="none" 
                      stroke={paths.M_to_Y ? "#4f46e5" : "#1e293b"} 
                      strokeWidth={paths.M_to_Y ? "2.5" : "1.5"}
                      strokeDasharray={paths.M_to_Y ? "0" : "4,4"}
                      markerEnd={paths.M_to_Y ? "url(#arrow)" : "url(#arrow-muted)"}
                      className="hover:stroke-indigo-400 transition-colors"
                    />
                    <rect x="240" y="150" width="22" height="14" rx="3" fill="#07090e" stroke={paths.M_to_Y ? "#4f46e5" : "#1e293b"} strokeWidth="1" />
                    <text x="251" y="160" textAnchor="middle" fill={paths.M_to_Y ? "#818cf8" : "#475569"} className="text-[8px] font-mono font-bold select-none">{paths.M_to_Y ? "ON" : "OFF"}</text>
                  </g>
                  ...
                  <g className="cursor-pointer" onClick={() => setPaths({ ...paths, T_to_Y: !paths.T_to_Y })}>
                    <path 
                      ...
                      fill="none" 
                      stroke={paths.T_to_Y ? "#4f46e5" : "#1e293b"} 
                      strokeWidth={paths.T_to_Y ? "2.5" : "1.5"}
                      strokeDasharray={paths.T_to_Y ? "0" : "4,4"}
                      markerEnd={paths.T_to_Y ? "url(#arrow)" : "url(#arrow-muted)"}
                      className="hover:stroke-indigo-400 transition-colors"
                    />
                    <rect x="188" y="113" width="22" height="14" rx="3" fill="#07090e" stroke={paths.T_to_Y ? "#4f46e5" : "#1e293b"} strokeWidth="1" />
                    <text x="199" y="123" textAnchor="middle" fill={paths.T_to_Y ? "#818cf8" : "#475569"} className="text-[8px] font-mono font-bold select-none">{paths.T_to_Y ? "ON" : "OFF"}</text>
                  </g>

                  {/* Node: Seasonality (X) */}
                  <g>
                    <circle cx="200" cy="40" r="20" fill="#0c121e" stroke="#10b981" strokeWidth="2" />
                    <text x="200" y="44" textAnchor="middle" fill="#10b981" className="text-[10px] font-bold font-outfit">X</text>
                    <text x="200" y="15" textAnchor="middle" fill="#cbd5e1" className="text-[9px] font-semibold">Seasonality (X)</text>
                  </g>

                  {/* Node: Campaign Spending (T) */}
                  <g>
                    <circle cx="100" cy="120" r="20" fill="#0c121e" stroke="#4f46e5" strokeWidth="2.5" />
                    <text x="100" y="124" textAnchor="middle" fill="#818cf8" className="text-[10px] font-bold font-outfit">T</text>
                    <text x="100" y="153" textAnchor="middle" fill="#cbd5e1" className="text-[9px] font-semibold">Campaign Spend (T)</text>
                  </g>

                  {/* Node: Sales Revenue (Y) */}
                  <g>
                    <circle cx="300" cy="120" r="20" fill="#0c121e" stroke="#6366f1" strokeWidth="2.5" />
                    <text x="300" y="124" textAnchor="middle" fill="#818cf8" className="text-[10px] font-bold font-outfit">Y</text>
                    <text x="300" y="153" textAnchor="middle" fill="#cbd5e1" className="text-[9px] font-semibold">Revenue (Y)</text>
                  </g>

                  {/* Node: Direct Visits (M) - Mediator */}
                  <g>
                    <circle cx="200" cy="200" r="20" fill="#0b0e14" stroke="#475569" strokeWidth="1.5" />
                    <text x="200" y="204" textAnchor="middle" fill="#94a3b8" className="text-[10px] font-bold font-outfit">M</text>
                    <text x="200" y="233" textAnchor="middle" fill="#cbd5e1" className="text-[9px] font-semibold font-outfit">Direct Visits (M)</text>
                  </g>
                </svg>
              </div>

              {/* Adjustments control panel */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 border-t border-slate-900 pt-4 mt-2 select-none">
                <div className="flex items-center justify-between p-3 rounded-lg border border-slate-800 bg-[#0b0e14]">
                  <div className="space-y-0.5">
                    <span className="text-[11px] font-bold text-slate-300 block">Condition on Seasonality (X)</span>
                  ...
                  <input 
                    ...
                    className="h-4 w-4 accent-emerald-500 bg-slate-900 border-slate-800 rounded focus:ring-0 cursor-pointer"
                  />
                </div>

                <div className="flex items-center justify-between p-3 rounded-lg border border-slate-800 bg-[#0b0e14]">
                  <div className="space-y-0.5">
                    <span className="text-[11px] font-bold text-slate-300 block">Condition on Direct Visits (M)</span>
                    <span className="text-[9px] text-slate-500 text-amber-500/80">Warning: mediator variable</span>
                  </div>
                  <input 
                    type="checkbox" 
            ...
            <div className="lg:col-span-5 border border-slate-800 bg-[#07090e] rounded-2xl p-5 flex flex-col justify-between relative overflow-hidden">
              <div className="space-y-6">
                ...
                <div className="bg-slate-950 p-4 border border-slate-900 rounded-xl space-y-2">
                  ...
                  <div className="font-mono text-xs text-center py-2 text-white bg-black/40 rounded border border-slate-900/60 font-semibold select-all">
                    {sandboxStatus === "unbiased" && (
                      <span>E[Y | do(T)] = {adjustConfounder ? "∑ₓ E[Y | T, X=x] P(X=x)" : "E[Y | T]"}</span>
                    )}
                    {sandboxStatus === "confounded" && (
                      <span className="text-red-400">E[Y | do(T)] ≠ E[Y | T] (Bias)</span>
                    )}
                    {sandboxStatus === "overcontrolled" && (
                      <span className="text-amber-400">E[Y | do(T)] = E[Y | T, X] (Blocks M path)</span>
                    )}
                  </div>
                ...
                <div className="space-y-4 pt-2">
                  <div className="space-y-1">
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-400">True total Causal Effect:</span>
                      <span className="text-white font-mono font-bold">${trueEffect.toFixed(2)}</span>
                    </div>
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-400">Estimated Effect (Model Output):</span>
                      <span className={`font-mono font-bold ${sandboxStatus === "unbiased" ? "text-emerald-400" : sandboxStatus === "confounded" ? "text-red-400" : "text-amber-400"}`}>
                        ${estimatedEffect.toFixed(2)}
                      </span>
                    </div>
                    <div className="w-full bg-slate-950 h-2 rounded-full overflow-hidden">
                      <div 
                        className={`h-full rounded-full transition-all duration-300 ${sandboxStatus === "unbiased" ? "bg-emerald-500" : sandboxStatus === "confounded" ? "bg-red-500" : "bg-amber-500"}`} 
              ...
              <div className="text-[11px] text-slate-500 leading-relaxed border-t border-slate-900 pt-4 mt-6 flex items-start gap-2">
      ...
      {/* ────────────────────────────────────────────────────────────────────────
          ...
          ──────────────────────────────────────────────────────────────────────── */}
      <section id="docs-preview" className="py-24 border-t border-slate-900 bg-[#06080d]/40 relative">
        <div className="max-w-[1000px] mx-auto px-6">
          ...
          <div className="border border-slate-800 bg-[#080a10] rounded-2xl p-5 md:p-6 shadow-xl grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
            
            {/* Left Column: Chapters selection */}
            <div className="md:col-span-4 flex flex-row md:flex-col gap-2 overflow-x-auto md:overflow-visible pb-4 md:pb-0 border-b md:border-b-0 md:border-r border-slate-900 md:pr-6 select-none shrink-0">
              <button 
                onClick={() => setActiveDocTab("foundations")}
                className={`w-full text-left px-4 py-3 rounded-lg text-xs font-semibold border transition-all ${activeDocTab === "foundations" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : "bg-transparent border-transparent text-slate-400 hover:text-slate-200 hover:bg-slate-900/40"}`}
              >
              ...
              <button 
                ...
                className={`w-full text-left px-4 py-3 rounded-lg text-xs font-semibold border transition-all ${activeDocTab === "doubleml" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : "bg-transparent border-transparent text-slate-400 hover:text-slate-200 hover:bg-slate-900/40"}`}
              >
              ...
              <button 
                ...
                className={`w-full text-left px-4 py-3 rounded-lg text-xs font-semibold border transition-all ${activeDocTab === "uplift" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : "bg-transparent border-transparent text-slate-400 hover:text-slate-200 hover:bg-slate-900/40"}`}
              >
            ...
            <div className="md:col-span-8 flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-3">
                <span className="text-[10px] font-mono text-emerald-400 font-bold uppercase tracking-wider">{docContents[activeDocTab].chapter}</span>
                <h3 className="text-lg font-bold text-white font-outfit">{docContents[activeDocTab].title}</h3>
                <p className="text-slate-400 text-xs leading-relaxed">{docContents[activeDocTab].excerpt}</p>
              </div>

              {/* Mock code block */}
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-900 font-mono text-[10px] text-slate-300 leading-relaxed overflow-x-auto">
      ...
      <section className="relative z-10 max-w-[1300px] mx-auto px-6 py-20 border-t border-slate-900 bg-[#050608]/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="border border-slate-900 bg-slate-950/40 p-6 rounded-xl space-y-4 hover:border-slate-800 hover:bg-slate-900/30 transition-all duration-300">
            <div className="h-10 w-10 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center">
              <Cpu className="h-5 w-5 text-emerald-400" />
            </div>
            <div className="space-y-2">
              <h3 className="text-lg font-bold text-white tracking-tight font-outfit">Causal Graph Discovery</h3>
          ...
          <div className="border border-slate-900 bg-slate-950/40 p-6 rounded-xl space-y-4 hover:border-slate-800 hover:bg-slate-900/30 transition-all duration-300">
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-bold text-white tracking-tight font-outfit">Estimator Comparisons</h3>
              <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
          ...
          <div className="border border-slate-900 bg-slate-950/40 p-6 rounded-xl space-y-4 hover:border-slate-800 hover:bg-slate-900/30 transition-all duration-300">
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-bold text-white tracking-tight font-outfit">Customer Uplift Targeting</h3>
              <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-slate-900 max-w-[1300px] mx-auto px-6 py-10 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
        ...
        <div className="flex items-center gap-6">
          <a href="/docs" target="_blank" rel="noreferrer" className="hover:text-slate-300 transition-colors">Documentation</a>
